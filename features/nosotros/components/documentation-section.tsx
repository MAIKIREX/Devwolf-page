        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <OffsetCardWrapper>
            <Card className="p-6 text-center hover:shadow-lg transition-shadow ">
              ...
              <p className="text-muted-foreground">
                Memoria técnica resumida, planos/as-built básicos y lista
          ...
          <OffsetCardWrapper>
            <Card className="p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                Certificados de equipos y reportes de pruebas (medición de
                puesta a tierra, etc.)
              </p>
            </Card>
          </OffsetCardWrapper>
          ...
          <OffsetCardWrapper>
            <Card className="p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                Documentación completa para operación y mantenimiento de
                sistemas instalados
              </p>
            </Card>
          </OffsetCardWrapper>
