...
export function NosotrosCoverageSection() {
  return (
    <section className="py-20 bg-background h-screen flex items-center">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <MapPin className="h-12 w-12 mx-auto mb-4 text-primary" />
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-secondary mb-4 dark:text-foreground">Cobertura Geográfica</h2>
          </div>
          ...
          <Card className="p-8 shadow-xl">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-4 px-4 py-4 border-t-2 md:border-l-2 md:border-t-0 border-primary ">
                <div>
                  <h3 className="font-heading text-xl font-semibold text-secondary mb-3 dark:text-foreground">Cobertura Nacional</h3>
                ...
                <div>
                  <h3 className="font-heading text-xl font-semibold text-secondary mb-3 dark:text-foreground">Otros Departamentos</h3>
                  <p className="text-muted-foreground leading-relaxed">
